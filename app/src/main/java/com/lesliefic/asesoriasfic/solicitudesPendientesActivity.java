...
import com.lesliefic.asesoriasfic.databinding.ActivitySolicitudesPendientesBinding;

public class solicitudesPendientesActivity extends DrawerBaseActivity {

    ActivitySolicitudesPendientesBinding activitySolicitudesPendientesBinding;
